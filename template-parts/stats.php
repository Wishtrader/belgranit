...
<section class="relative overflow-hidden py-16 lg:py-20">
	<?php if ($bg_image): ?>
		<img src="<?php echo
    		esc_url($bg_image)
		; ?>" alt="" class="pointer-events-none absolute inset-0 h-full w-full object-cover" aria-hidden="true">
	<?php endif; ?>
	<div class="relative mx-auto flex items-center justify-center flex-col lg:flex-row max-w-[1200px] gap-10">
		...
		<div class="text-center max-w-[234px]">
			<div class="mx-auto flex h-[76p] w-[76px] items-center justify-center rounded-full border-[1px] border-[#860000] text-white">
