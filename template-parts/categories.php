...
<section id="catalog" class="mx-auto max-w-[1200px] px-[10px] lg:px-0 py-16 lg:py-20">
  <div class="mb-11 flex flex-col items-center gap-5">
    ...
    ; ?>/img/divider.svg" alt="" class="h-[22px] w-[114px]" width="114" height="22">
  </div>
      ...
      <div class="relative h-[374px] xl:h-[530px]">
        ...
        <div class="absolute bottom-0 left-0 right-0 p-2 lg:p-5">
          <div class="max-w-[220px]">
            ...
            <a href="<?php echo
                esc_url($link_url)
            ; ?>" class="mt-5 inline-flex items-center gap-3 font-manrope text-sm font-bold text-ink hover:text-[#860000]">
              Смотреть
