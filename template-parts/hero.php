...
?>
<section class="w-full lg:h-[800px] lg:max-h-screen overflow-hidden bg-[url('<?php echo
    esc_url($hero_bg_image)
; ?>')] bg-cover bg-bottom lg:bg-center pb-10">
	...
	<div class="relative max-w-[1200px] md:mx-auto px-2 mx-[10px] mt-[120px] lg:mt-[160px] lg:mt-[220px] text-center flex flex-col items-center justify-start border-[1px] border-white pt-10 pb-8 md:pb-0">
		...
		<a href="#callback" data-popup="calculate" class="w-full sm:w-auto inline-flex items-center justify-center bg-[#860000] hover:bg-[#650d10] text-white text-base font-semibold uppercase tracking-wide px-8 py-4 rounded-[6px] transition-colors">
			...
			<a href="#catalog" class="w-full sm:w-auto inline-flex items-center justify-center bg-white/80 hover:bg-gray-100 text-[#860000] text-base font-semibold uppercase tracking-wide px-8 py-4 rounded-[6px] transition-colors">
				Перейти в каталог
			</a>
		</div>
	</div>
